...
st.markdown(
    "<h1 style='text-align: center;'>Superstore Sales Performance in The US</h1>",
...
# # Data yang ingin Anda sembunyikan dalam "spoiler"
# spoiler_data = "Ini adalah teks yang dispoilerkan!"

# # Membuat expander untuk "spoiler"
# with st.expander("Klik di sini untuk melihat spoiler"):
#     st.write(spoiler_data)

# # Data di luar expander (tidak tersembunyi)
# st.write("Data ini tidak dispoilerkan.")
    
# spoiler_data = df.to_markdown()

# # Membuat expander untuk "spoiler"
# with st.expander("Klik di sini untuk melihat data CSV"):
#     st.markdown(spoiler_data, unsafe_allow_html=True)
    
st.write("Superstore Data in details")
st.dataframe(df)

st.write("Superstore Data in conclusion")
